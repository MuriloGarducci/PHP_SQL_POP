...
<body>
    ...
    <div class="form-container">
        <fieldset>
            <legend>Músicas das Bandas</legend>
            <?php
            try {
            ...
            // Consulta para selecionar bandas e suas músicas
            $sql = "SELECT b.nome AS nome_banda, m.nome AS nome_musica
                    FROM bandas AS b
                    LEFT JOIN musicas AS m ON b.id = m.banda_id";
            ...
            if ($rs) {
                ...
                while ($registro = $rs->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    $nomeMusica = $registro['nome_musica'];
                    ...
                    // Exibe a música
                    if ($nomeMusica) { // Verifica se a banda tem músicas cadastradas
                        echo "<li>$nomeMusica</li>";
                    } else {
                        echo "<li>Nenhuma música cadastrada.</li>"; 
                    }
                }
        ...
        <p><a href="registro_musicas.php">Cadastrar Música</a></p>
