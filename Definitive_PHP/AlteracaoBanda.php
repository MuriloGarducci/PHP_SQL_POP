...
// Atualização da banda

if (isset($_REQUEST["atualizar"]) && $_REQUEST["atualizar"] == true) {
    if (isset($_POST["bandas_id"]) && !empty($_POST["bandas_id"]) && isset($_POST["novo_nome"]) && !empty($_POST["novo_nome"])) {

        // Altere o nome da banda
        $sql = "UPDATE bandas SET nome = ? WHERE id = ?";
        $stmt = $connection->prepare($sql);
        $stmt->bindParam(1, $_POST["novo_nome"]);
        $stmt->bindParam(2, $_POST["bandas_id"]);
        $stmt->execute();
        ...
        $erro = "Selecione uma banda e informe o novo nome.";
    }
} 

// Obter todas as bandas ativas para o dropdown
...
<head>
    ...
    <title>Atualização de Bandas</title>
    <style>
        body {
            margin-top:10%;
...
<body>
    <div class="stars"></div>
    <h2>Atualização de Bandas</h2>

    <?php if ($atualizar == true){ ?>
        <p>Banda atualizada com sucesso!</p>
        <p><a href='bandas.php'>Visualizar bandas atualizadas</a></p>
    <?php } else { ?>
        <?php if (isset($erro)){?>
        ...
        <div class="form-container">
            <form method="POST" action="?atualizar=true">
                <div class="form-group">
                    ...
                    <select name="bandas_id" id="bandas_id" required>
                ...
                <div class="form-group">
                    <label for="novo_nome">Novo Nome da Banda:</label>
